        ...
        <div className="min-h-screen bg-white text-gray-900 font-sans p-12">
            <div className="max-w-4xl mx-auto">
                <div className="mb-10">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-2">Convert Image</h1>
                    <p className="text-gray-500">Convert between PNG, JPG, WebP and more.</p>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-4 flex items-center justify-between">
                        <div className="text-sm min-h-[20px]">
                            {status === 'success' && <span className="text-green-600 font-medium">✨ Image converted successfully!</span>}
                            {status === 'error' && <span className="text-red-600 font-medium">❌ Error converting image.</span>}
